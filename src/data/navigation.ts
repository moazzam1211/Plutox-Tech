...
export const routes: Route[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Plutox ID", href: "/products#plutox-id", hint: "Passwordless sign-in" },
      { label: "INDUX", href: "/products#indux", hint: "Manufacturing ERP" },
      { label: "VitaDrop", href: "/products#vitadrop", hint: "Blood donation platform" },
  ...
  },
  {
    ...
    href: "/projects",
    short: "Projects",
    summary: "Seven platforms, built here",
    children: [
      ...
      { label: "Plutox ID", href: "/projects/plutox-id", hint: "Passwordless sign-in" },
      { label: "INDUX", href: "/projects/indux", hint: "Manufacturing ERP" },
      { label: "VitaDrop", href: "/projects/vitadrop", hint: "Blood donation platform" },
    ],
    icon: Briefcase,
  },
  {

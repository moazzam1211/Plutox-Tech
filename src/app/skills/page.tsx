  ...
  return (
    <>
      ...
      <PageHeader
        ...
        lede="Not a list of things learned once and delegated since. Every one of these is used on live client work — the four shipped products and the one in build are built with them."
      >
        <StatStrip

  ...
  return (
    <>
      ...
      <PageHeader
        ...
        lede="Not a list of things learned once and delegated since. Every one of these is used on live client work — every one of the six platforms is built with them."
      >
        <StatStrip
